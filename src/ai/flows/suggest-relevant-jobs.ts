...
const SuggestRelevantJobsInputSchema = z.object({
  profile: z
    .string()
    .describe('The job seeker profile, including skills and experience.'),
  searchHistory: z
    .string()
    .describe('The job seeker search history, including job titles and keywords.'),
});
...
const SuggestRelevantJobsOutputSchema = z.object({
  jobSuggestions: z
    .array(z.string())
    .describe('A list of job suggestions tailored to the profile and search history.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a job suggestion expert.

  Based on the job seeker's profile and search history, you will provide a list of job suggestions.
